...
@petercord.on_cmd("gpsetup", about={'header': "setup gphotos"})
...
async def create_token_file():
    ...
    async with petercord.conversation(Config.LOG_CHANNEL_ID, timeout=150) as conv:
...
@petercord.on_cmd("gpupload", about={
    'header': "upload files to gphoto",
    'petercord': "{tr}gpupload [link | path | reply to media]",
    'examples': [
