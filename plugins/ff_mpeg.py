...
@petercord.on_cmd("ffmpegsave", about={'header': "Save a media that is to be used in ffmpeg"})
...
@petercord.on_cmd("ffmpegtrim", about={
    'header': "Trim a given media",
    'petercord': "{tr}ffmpegtrim [start time] [end time]"})
