...
@petercord.on_cmd("modi", about={
    'header': "Custom Sticker of Modi Tweet",
    'petercord': "{tr}modi [text | reply to text]"})
...
@petercord.on_cmd("cmm", about={
    'header': "Custom Sticker of Change My Mind",
    'petercord': "{tr}cmm [text | reply to text]"})
...
@petercord.on_cmd("carry", about={
    'header': "Custom text Sticker of Carryminati",
    'petercord': "{tr}carry [text | reply to text]"})
...
@petercord.on_cmd("tweet", about={
    'header': "Tweet With Custom text Sticker",
    'petercord': "{tr}tweet username text\n"
