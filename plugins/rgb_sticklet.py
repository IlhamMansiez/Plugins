...
@petercord.on_cmd("plet", about={
    'header': "Get a Random RGB Sticker",
    'description': "Generates A RGB Sticker with provided text",
    'petercord': "{tr}plet [text | reply]",
    'examples': "{tr}plet @petercord"}, allow_via_bot=False)
...
async def get_font_file():
    ...
    return await petercord.download_media(font_file_message)
