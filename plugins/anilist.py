...
from petercord.utils import progress, take_screen_shot
userge = petercord 
# Logging Errors
CLOG = petercord.getCLogger(__name__)
...
@petercord.on_cmd("airing", about={
    'header': "Airing Info",
    'description': "Fetch Airing Detail of a Anime",
    'petercord': "{tr}airing [Anime Name | Anilist ID]",
...
@petercord.on_cmd("scheduled", about={
...
@petercord.on_cmd("character", about={
...
@petercord.on_cmd("setemp", about={
    ...
    'petercord': "{tr}setemp [Reply to text Message | Content]"})
...
@petercord.on_cmd("anitemp", about={
    ...
    'petercord': "{tr}anitemp [A valid flag]"})
