...
@petercord.on_cmd("add", about={
    'header': "Returns the addition of given numbers.",
    'petercord': "{tr}add [ X + Y ]\n\n{tr}add 6969 + 6969"})
...
@petercord.on_cmd("divide", about={
    'header': "Returns the division of given numbers.",
    'petercord': "{tr}divide [ X / Y ]\n\n{tr}divide 6969 / 6969"})
...
@petercord.on_cmd("factorial", about={
    'header': "Returns the factorial of X number.",
    'petercord': "{tr}factorial [ X number ]\n\n{tr}factorial 6969"})
...
@petercord.on_cmd("power", about={
    'header': "Returns X raised to the power Y.",
    'petercord': "{tr}power [ X ^ Y ]\n\n{tr}power 6969 ^ 6969"})
...
@petercord.on_cmd("sqrt", about={
    'header': "Returns the sqaure root of X number.",
    'petercord': "{tr}sqrt [ X number ]\n\n{tr}sqrt 6969"})
...
@petercord.on_cmd("sin", about={
    'header': "Returns the SINE function(x)",
    'petercord': "{tr}sin [ X number ]\n\n{tr}sin 69"})
...
@petercord.on_cmd("cos", about={
    'header': "Returns the COSINE function(x)",
    'petercord': "{tr}cos [ X number ]\n\n{tr}cos 69"})
...
@petercord.on_cmd("tan", about={
    'header': "Returns the TANGENT(x)",
    'petercord': "{tr}tan [ X number ]\n\n{tr}tan 69"})
...
@petercord.on_cmd("deg", about={
    'header': "Converts angle X from radians to degrees",
    'petercord': "{tr}deg [ X number ]\n\n{tr}deg 69"})
...
@petercord.on_cmd("rad", about={
    'header': "Converts angle X from degrees to radians",
    'petercord': "{tr}rad [ X number ]\n\n{tr}rad 69"})
...
@petercord.on_cmd("log", about={
    'header': "Returns the logarithm of X to the base",
    'petercord': "{tr}log [ X number ]\n\n{tr}log 69"})
