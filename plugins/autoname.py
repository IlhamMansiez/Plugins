...
@petercord.on_cmd("santo", about={
    'header': "Set Auto Name timeout",
    'petercord': "{tr}santo [timeout in seconds]",
...
@petercord.on_cmd("vanto", about={'header': "View Auto Name timeout"})
