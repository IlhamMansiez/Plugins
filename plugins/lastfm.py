...
@check_creds
@petercord.on_cmd("getuser", about={
    'header': "Get user of lastfm.",
    'petercord': "{tr}getuser\n{tr}getuser [username]"})
...
@check_creds
@petercord.on_cmd("lovesong", about={
    ...
    'petercord': "{tr}lovesong (if listening any song)\n{tr}lovesong Artist - Title"})
...
@check_creds
@petercord.on_cmd("getloved", about={
    'header': "Get list of all loved tracks.",
    'petercord': "{tr}getloved\n{tr}getloved 20"})
...
@check_creds
@petercord.on_cmd("getrack", about={
    'header': "Get track of lastfm.",
    'petercord': "{tr}getrack\n{tr} getrack Artist - Title"})
        ...
        if NOW_PLAYING[1] != song.get_name():
            ...
            for chat_id in CHAT_IDS:
                ...
                if petercord.has_bot:
                    try:
                        await petercord.bot.send_message(
