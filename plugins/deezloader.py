...
from petercord.plugins.misc.upload import doc_upload, audio_upload
userge = petercord
Clogger = petercord.getCLogger(__name__)
...
@petercord.on_cmd("deezload", about={
    'header': "DeezLoader for Petercord",
    ...
    'petercord': "{tr}deezload [flag] [link | quality (default MP3_320)]",
