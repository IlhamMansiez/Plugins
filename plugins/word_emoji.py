...
@petercord.on_cmd("hii", about={
    'header': "Use HI to greet someone",
    'petercord': "{tr}hii [foreground emoji] , [background emoji]"})
...
@petercord.on_cmd("wtf", about={
    'header': "WTF Generally stands for 'What the fuck' use for fun",
    'petercord': "{tr}wtf [foreground emoji] , [background emoji]"})
