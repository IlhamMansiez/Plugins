...
from petercord.utils import progress, take_screen_shot, runcmd

userge = petercord

@petercord.on_cmd("deepfry", about={
    'header': "Deep Fryer",
    'description': "Well deepfy any image/sticker/gif and make it look ugly",
    'petercord': "{tr}deepfry [fry count] as a reply.",
...
@petercord.on_cmd("fry", about={
    'header': "frying media",
    'petercord': "{tr}fry [fry count (recommendation 3)] [reply to any media]",
