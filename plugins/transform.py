...
from petercord.utils import take_screen_shot, runcmd

Converted = Config.DOWN_PATH + "sticker.webp"


@petercord.on_cmd("(ghost|invert)", about={
    'header': "Invert media as looking like a ghost",
    'petercord': "{tr}ghost [reply to any media]\n"
...
@petercord.on_cmd("(mirror|flip)", about={
    'header': "Mirror and flip any media",
    'petercord': "{tr}mirror [reply to any media]\n"
...
@petercord.on_cmd("rotate", about={
    'header': "Rotate any media",
    'petercord': "{tr}rotate [angle to rotate] [reply to media]\n"
