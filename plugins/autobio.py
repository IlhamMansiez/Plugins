...
@petercord.on_cmd("sabto", about={
    'header': "Set auto bio timeout",
    'petercord': "{tr}sabto [timeout in seconds]",
...
@petercord.on_cmd("vabto", about={'header': "View auto bio timeout"})
